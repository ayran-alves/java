...
public static void main(String[] args) {
		...
		System.out.print("Digite um número de 1 a 7 para representar o dia da semana (1=Domingo, 7=Sábado): ");
...
//2
                ...
                System.out.println("1 Café 5,00");
                System.out.println("2  Chá 3,50");
                System.out.println("3 - Suco: 4,00");
                System.out.println("4 - Refrigerante: 4,50");
                System.out.print("Digite o código da bebida desejada: ");
                int codigo = scanner.nextInt();

                switch (codigo) {
                    case 1:
                        System.out.println("O preço do Café é R$5,00");
                        break;
                    case 2:
                        System.out.println("O preço do Chá é R$3,50");
                        break;
                    case 3:
                        System.out.println("O preço do Suco é R$4,00");
                        break;
                    case 4:
                        System.out.println("O preço do Refrigerante é R$4,50");
                        break;
                    default:
